    ...
    <footer className="footer white-bg black-color">
      <div className="footer-container">
        ...
        <div className="footer-link-policy">
          <a
            target="_blank"
            href="https://web.archive.org/web/20240602184037/https://ittcon.eu/legal"
          >
            <p className="black-color">Legal</p>
          </a>
          <a
            target="_blank"
            href="https://web.archive.org/web/20240602184559/https://ittcon.eu/cookie-policy"
          >
            <p className="black-color">Cookie Policy</p>
          </a>
          <a
            target="_blank"
            href="https://web.archive.org/web/20240602185513/https://ittcon.eu/privacy-policy"
          >
            <p className="black-color">Privacy Policy</p>
          </a>
        </div>
      </div>
